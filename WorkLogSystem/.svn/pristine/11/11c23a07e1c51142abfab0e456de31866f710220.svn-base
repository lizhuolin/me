  ...
  <div class="edit">
    <ul>
      <li>
        ...
        <input id="startTime"  type="text" name="tblLog.logTime" value="${date }" /><samp></samp>
      	...
      	<s:iterator value="projectList" status="s">
			<li>
				<span><i><input class="project" type="checkbox"/> 项目名称</i><samp>:</samp>
		...
		<s:iterator value="taskList" status="s">
			<li>
				<span><i><input type="checkbox"/> 任务名称</i><samp>:</samp>
		...
		<li>
				<span><i><input type="checkbox"/> 其他</i><samp>:</samp>	
				</span>
				<span><i>工时</i><samp>:</samp>
      ...
      <span><i>文件</i><samp>:</samp>
		        ...
		        <input class="logUpload" type="file" name="logUpload" id="logUpload" onchange="ajaxFileUpload()"/>
