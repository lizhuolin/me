        ...
        <table border="1" bordercolor="#ccc">
          ...
          <tr>
		     ...
		     <%--  <th><s:property value="companyAdmin"/></th> --%>
		      ...
		      <a id="find"  onclick="findAdmin('<s:property value='companyId'/>')">管理员信息</a></s:if>
		      </td>
		      
		      <td align="center">
            	<a id="check" onclick="checkOut8('<s:property value='companyId'/>')">公司详情</a>
              </td>
