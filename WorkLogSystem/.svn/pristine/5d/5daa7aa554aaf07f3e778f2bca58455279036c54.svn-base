...
<script src="<%=basePath %>/js/log/log.js?v1.0.1"></script>
	     ...
	     <!-- 第二步：写自己查询需要的数据  需要提交的查询表单数据 start -->
	      <div class="con_top">
	        <div class="con_search">
	          <span>日期：<s:textfield id="startTime" type="text" name="tblLog.logTime" /></span>
...
<div class="content">
   ...
   <pb:pri privilege="add" module="log">
      ...
      <pb:pri privilege="edit" module="log"> <a id="edit">修改</a>  </pb:pri>
      ...
      <div class="con_disc">
        <table border="1" bordercolor="#ccc">
          ...
          <tr>
            ...
            <td align="center"><s:date name="logTime" format="yyyy-MM-dd"/></td>
            ...
            <td><s:if test='logPicture!=null && logPicture!=""'><img id="showImg" src="<%=basePath %><s:property value='logPicture'/>" width="50px" height="50px"></s:if>
            <s:else>暂无图片</s:else></td>
            <td align="center">
