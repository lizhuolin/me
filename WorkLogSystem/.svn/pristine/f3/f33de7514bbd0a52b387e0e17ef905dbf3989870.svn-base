   ...
   <input type="hidden" id="actionUrl" value="<%=basePath %>/project/projectchild_projectChildList.action"/>
	 <div class="main_top">
	     ...
	     <div class="con_top">
	        ...
	        <span>子项目名：<s:textfield type="text" name="tblProjectChild.projectName"/></span>
            <!--<span>子项目状态:<s:select  name="tblProjectChild.projectChildStatus" list="#{0:'未开始',1:'进行中',2:'已结束'}" headerKey="" headerValue="全部"/> </span> --> 
        ...
        <table border="1" bordercolor="#ccc">
         ...
         <s:iterator value="pageList.dataList" >
          ...
          <tr>
           ...
           <td align="center"><s:date name="projectChildStarttime" format="yyyy-MM-dd "/></td>
           <td align="center"><s:date name="projectChildEndtime" format="yyyy-MM-dd "/></td>
           <td align="center"><s:date name="projectChildRealstarttime" format="yyyy-MM-dd "/></td>
           <td align="center"><s:date name="projectChildRealendtime" format="yyyy-MM-dd "/></td>
