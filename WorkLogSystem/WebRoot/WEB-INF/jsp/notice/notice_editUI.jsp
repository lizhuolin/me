	    ...
	    <s:hidden name="notice.noticeCreaterId"/>
	        ...
	        <span id="showImg">
	         ...
	         <s:else></s:else>
               ...
               <input id="startTime4" class="middle" value="${notice.noticeStartTime }" name="notice.noticeStartTime" type="text" />
                </span>
			   
			     <span>
			    <i>结束推送时间</i><samp>:</samp>
               <input id="endTime4" class="middle" value="${notice.noticeEndTime }" name="notice.noticeEndTime" type="text" />
                </span>
			    </li>
				<%-- <li>
