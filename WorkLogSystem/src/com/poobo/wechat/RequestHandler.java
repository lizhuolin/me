...
//		log.debug("UrlEncode后 packageValue=" + packageValue);
		return packageValue;
	}
	...
	public String createSign(SortedMap<String, String> packageParams) {
		...
		log.debug("md5 sb:" + sb+"key="+this.getKey());
		String sign = MD5Util.MD5Encode(sb.toString(), this.charset)
				.toUpperCase();
		log.debug("packge签名:" + sign);
		return sign;
	 ...
	 * 创建package签名
	 */
	public boolean createMd5Sign(String signParams,String charEncoding) {
		StringBuffer sb = new StringBuffer();
